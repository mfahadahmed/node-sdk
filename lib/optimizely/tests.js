  ...
  describe('feature management', function() {
    ...
    describe('getEnabledFeatures', function() {
      ...
      it('returns sorted feature-key list ', function() {
        var optimizelyInstance = new Optimizely({
          clientEngine: 'node-sdk',
          datafile: testData.getTestProjectConfigWithFeatures(),
          eventBuilder: eventBuilder,
          errorHandler: errorHandler,
        ...
        sinon.stub(optimizelyInstance, 'isFeatureEnabled', function(featureKey) {
          return true;
        });
        ...
        var attributes = { test_attribute: 'test_value' };
        var result = optimizelyInstance.getEnabledFeatures('user1', attributes);
        assert.deepEqual(result, sortedFeatures);

        sinon.assert.callCount(optimizelyInstance.isFeatureEnabled, 6);
        sinon.assert.calledWithExactly(
          optimizelyInstance.isFeatureEnabled,
          'test_feature',
          'user1',
          attributes
        );
